...
public class Database {
    public final String url_database = "jdbc:mysql://localhost:3306/db_shop";
    public final String username_database = "root";
    public final String password_database = "0396294429";
    public final String models_entity_database = "com.api.shop.models";
